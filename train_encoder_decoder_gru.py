...
if __name__ == "__main__":
    ...
    parser.add_argument("--hidden_size", default = 128, type = int, help='output file for test translations')
    ...
    src_vocab, tgt_vocab, train_dataloader = get_dataloader(args.train_file, args.batch_size, max_size = 20000, reverse = False)
